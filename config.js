...
export let COOKIE = process.env.COOKIE || "bp6NOR8LBglaGWg7y2hqlw%3D%3D"; // User cookie value
export let BROWSER = process.env.BROWSER || "edge"; // Browser type, defaults to "chrome"
